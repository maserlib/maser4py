...
# test data sample
DATA_FILES = {'cdpp': {'demeter': ['DMT_N1_1134_018401_20041105_235807_20041106_003155.DAT'],
...
def download_data_sample(database_name:str, reload:bool=False):
    try:
        ...
        raise KeyError(f"database '{database_name}' is not in the test data sample") from err
