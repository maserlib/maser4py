...
latex_documents = [
    (master_doc, "maser4py.tex", "maser4py Documentation", "MASER Team", "manual"),
]
...
man_pages = [(master_doc, "maser4py", "maser4py Documentation", [author], 1)]
