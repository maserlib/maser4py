...
def add_skeletoncdf_subparser(subparser):
    ...
    :return:
    """
    sktcdf_parser = subparser.add_parser(
        "skeletoncdf", help="Convert CDF skeleton table into binary CDF"
    )
    sktcdf_parser.add_argument(
        "skeletons", nargs="+", help="Input CDF skeleton file(s)"
    )
    sktcdf_parser.add_argument(
        "-o",
        "--output_dir",
    ...
    sktcdf_parser.add_argument(
        "--no-cdf", action="store_true", help='Do no generate output CDF "master" file'
    )
...
def add_skeletontable_subparser(subparser):
    ...
    :return:
    """
    cdfskt_parser = subparser.add_parser(
        "skeletontable", help="Convert CDF file into skeleton table"
    )
    cdfskt_parser.add_argument("cdf", nargs="+", help="Input CDF file(s)")
    cdfskt_parser.add_argument(
        "-x",
        "--to-xlsx",
        action="store_true",
