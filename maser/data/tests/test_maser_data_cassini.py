...
class StaticFunctionTest(unittest.TestCase):
    ...
    def test_from_file_result_class(self):
        ...
        self.assertIsInstance(load_data_from_file(input_file), CassiniKronosData)
...
class CassiniKronosDataClassTest(unittest.TestCase):
    ...
    def test_init_from_file(self):
        data = CassiniKronosData.from_file(rpws_root_path+'2012_181_270/n2/P2012181.00', verbose=verbose)
...
#        self.assertEqual(data.level_path(data.periods[0], data.dataset_name[0]), rpws_root_path+'2012_181_270/n2')
    ...
    def test_modes_from_interval(self):
        data = CassiniKronosData.from_interval(ydh_to_datetime('2012180.23'), ydh_to_datetime('2012181.01'), 'n2',
                                               verbose=verbose)
        modes = data.get_modes()
        self.assertEqual(len(modes.keys()), 1)
        self.assertEqual(list(modes.keys())[0], '41bc04a0e85e944f068c86e438700a05')
    ...
    def test_n3b_with_data(self):
        data = CassiniKronosData.from_file(rpws_root_path+'2012_181_270/n3b/N3b_dsq2012181.18')
    ...
    def test_n3b_without_data(self):
        data = CassiniKronosData.from_file(rpws_root_path+'2012_181_270/n3b/N3b_dsq2012181.00')
        self.assertIn('n1', list(data.data.keys()))
        self.assertIn('n2', list(data.data.keys()))
        self.assertIn('n3b', list(data.data.keys()))
    ...
    def test_n3e_data(self):
        data = CassiniKronosData.from_file(rpws_root_path+'2012_181_270/n3e/N3e_dsq2012181.00')
        self.assertIn('n1', list(data.data.keys()))
        self.assertIn('n2', list(data.data.keys()))
...
class CassiniKronosFileClassTest(unittest.TestCase):
    ...
    def test_inherited_class(self):
        file = CassiniKronosFile(rpws_root_path+'2012_181_270/n1/R2012181.00')
        self.assertIsInstance(file, MaserDataFromFile)

    def test_file_k(self):
        file = CassiniKronosFile(rpws_root_path+'2012_181_270/k/K2012181.00')
    ...
    def test_file_n2(self):
        file = CassiniKronosFile(rpws_root_path+'2012_181_270/n2/P2012181.23')
    ...
    def test_file_n3b(self):
        file = CassiniKronosFile(rpws_root_path+'2012_181_270/n3b/N3b_dsq2012181.00')
...
class CassiniKronosRecordsClassTest(unittest.TestCase):
    ...
    def test_iterator(self):
        o = CassiniKronosData.from_file(rpws_root_path+'2012_181_270/n2/P2012181.00', verbose=verbose)
        records = o.records()
