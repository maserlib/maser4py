...
file_path = root_data_path / "VG1_JUPITER" / "PRA_I" / "PRA_I.TAB"
...
class PDSPPIVoyagerPRAJupiterDataTest(unittest.TestCase):
    ...
    def test_class(self):
        obj = PDSPPIVoyagerPRAJupiterData("1979-01-06T00:00:00", "1979-01-06T01:00:00", 1,
                                          root_data_path=str(root_data_path))
        self.assertIsInstance(obj, MaserDataFromInterval)
        self.assertEqual(obj.data_path, str(root_data_path / 'VG1_JUPITER'))

    def test_get_frame_times(self):
        frame_times = PDSPPIVoyagerPRAJupiterData.get_frame_times(str(file_path))
    ...
    def test_load_data_frames(self):
        frames = PDSPPIVoyagerPRAJupiterData.load_data_frames(str(file_path), 1, 2)
